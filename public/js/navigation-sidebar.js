  ...
  constructor(containerId) {
    ...
    this.mainNavItems = [
      ...
      },
      {
        ...
        icon: icon('<path d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"/>'),
      },
      {
      ...
      },
      {
        ...
        icon: icon('<path d="M15.59 14.37a6 6 0 01-5.84 7.38v-4.8m5.84-2.58a14.98 14.98 0 006.16-12.12A14.98 14.98 0 009.631 8.41m5.96 5.96a14.926 14.926 0 01-5.841 2.58m-.119-8.54a6 6 0 00-7.381 5.84h4.8m2.581-5.84a14.927 14.927 0 00-2.58 5.84m2.699 2.7c-.103.021-.207.041-.311.06a15.09 15.09 0 01-2.448-2.448 14.9 14.9 0 01.06-.312m-2.24 2.39a4.493 4.493 0 00-1.757 4.306 4.493 4.493 0 004.306-1.758M16.5 9a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z"/>'),
      },
    ];
    ...
    this.systemNavItems = [
      ...
      {
        id: 'llm-cost', label: 'LLM Cost', path: '/llm-cost',
        icon: icon('<path d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>'),
      },
    ];
    ...
    return `
      ...
      <div class="rounded-xl bg-base-200 p-2.5 mb-2">
        ...
        <div class="flex items-center gap-0.5 mt-2 pt-2 border-t border-base-300">
          ...
          <a href="/profile" data-spa-link title="Edit profile" class="${btnCls}">
